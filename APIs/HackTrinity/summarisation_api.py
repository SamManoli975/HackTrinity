...
def summarise_text(summarising_input):
    ...
    payload = {
        ...
        "messages": [
            ...
            {"role": "user", "content": f"Your task is to generate a short summary of a law case in at most 150 words taking an unbiased view taking account points in favour and against. Do not include any indicator tokens that indicate this is a summary and dont include any special characters such as * or # in your answer: {summarising_input}"}
        ]
    }
